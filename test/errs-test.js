  ...
  .addBatch({
    'Using errs module': {
      'the unregister() method': {
        'should unregister the prototype': () => {
  ...
  .addBatch({
    'Using errs module': {
      'the merge() method': {
        ...
        'should preserve message specified in create': () => {
          var err = new Error('Msg!')
          err = errs.merge(err, { message: 'Override!' })
          assert.equal(err.message, 'Override!')
        },
        'should preserve properties specified': () => {
          var err = new Error('Msg!')
